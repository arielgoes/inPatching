...
plot 'PASTED_10000us_AVG_single-flow.txt' using ($3/1000):4:xtic(1) t 'Reaction time 10 us' fs pattern 1 lt -1, \
	 'PASTED_20000us_AVG_single-flow.txt' using ($3/1000):4:xtic(1) t 'Reaction time 20 us' fs pattern 2 lt -1, \
	 'PASTED_30000us_AVG_single-flow.txt' using ($3/1000):4:xtic(1) t 'Reaction time 30 us' fs pattern 10 lt -1, \
	 'PASTED_40000us_AVG_single-flow.txt' using ($3/1000):4:xtic(1) t 'Reaction time 40 us' fs pattern 4 lt -1, \
	 'PASTED_50000us_AVG_single-flow.txt' using ($3/1000):4:xtic(1) t 'Reaction time 50 us' fs pattern 5 lt -1, \

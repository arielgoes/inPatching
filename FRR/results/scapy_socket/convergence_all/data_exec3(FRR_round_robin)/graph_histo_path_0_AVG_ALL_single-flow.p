...
#Teste stats on column 3, with attributes (e.g., mean, std_dev, ...) acessed by variable named 'A'
stats 'FRR_time_no-sleep_10000us_LINES_AVG_single-flow.txt' using ($3/1000) name "A"

...
plot 'Patcher_v0_time_no-sleep_stacked_AVG.txt' using ($4/1000):xtic(1) title 'Communication time (ms)' fs pattern 6 lt -1, \
'' using ($3/1000):xtic(1) t 'Control plane processing time (ms)' fs pattern 8 lt -1, \
